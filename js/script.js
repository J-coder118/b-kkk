...
(function ($) {
  $(document).ready(function () {
    ...
    const skillTags = [
      'Javascript', 'AI Chatbot', 'OpenAI', 'Git',
      'Typescript', 'PHP', 'Python', 'API',
      'NodeJS', 'MySQL', 'AWS', 'Supabase', 'PGVector', 'Llama-index', 
      'pinecone', 'ChromaDB',
      'TailwindCSS', 'PostgreSQL', 'ReactJS', 'Django',
      'ChatGPT', 'Next.js', 'LangChain', 'Prompt Engineering', "GPT-4", "Llama 3", "CDC", "MLOps", "RabbitMQ", "Docker", "HuggingFace", "Azure", "Multi-Modal", "Video-Chat"
    ];
